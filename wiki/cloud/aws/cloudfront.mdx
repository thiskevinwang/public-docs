...
This significantly cuts down on my GitHub API consumption especially at page regeneration time
and if I need to rebuild my site and have pages regenerated _again_.
...
Here's Postman Test script for handy observability.
